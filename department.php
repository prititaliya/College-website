            ...
            <div class="container marketing my-2">
                <div class="row featurette">
                    <div class="col-md-7 order-md-2">
                        ...
                        <p class="lead"><?php echo substr($row['dept_desc'],0,200);
                                        ?>...</p>
                        <p><a class="btn btn-secondary" href="departmentdetail.php?deptname=<?php echo $row['dept_name']; ?>">Read more»</a></p>
                    </div>
                    <div class="col-md-5">
                        <img class="Effect" style="border-radius: 25px;" src="resources/<?php echo $row['dept_id'] ?>.jpg" alt="resources/<?php echo $row['dept_id'] ?>.jpg
                        " height="250dp" width="75%">
            ...
            <div class="container marketing my-2">
                <div class="row featurette">
                    <div class="col-md-7">
                        <!-- <h2 class="featurette-heading"><?php echo $row['dept_name']; ?> <span class="text-muted">id.<?php echo $row['dept_id']; ?></span></h2> -->
                        <h4 id="scrollspyHeading1 featurette-heading"><?php echo $row['dept_name']." "; ?><span class="text-muted">id.<?php echo $row['dept_id']; ?></span></h4>
                        <p class="lead"><?php echo substr($row['dept_desc'],0,70);
                                        ?>....</p>
                        <p><a class="btn btn-secondary" href="departmentdetail.php?deptname=<?php echo $row['dept_name']; ?>">Read more»</a></p>
                    </div>
                    <div class="col-md-5">
                        <img class="Effect" style="border-radius: 25px;" src="resources/<?php echo $row['dept_id'] ?>.jpg" alt="resources/<?php echo $row['dept_id'] ?>.jpg" height="250dp" width="75%">
