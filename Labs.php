        ...
        if ($i % 2 == 0) {    ?>
            ...
            <div class="container marketing my-2">
                <div class="row featurette">
                    ...
                    <div class="col-md-5">
                        <?php
                        echo '<img class="Effect" style="width: 75%;border-radius: 25px;" width="225" height="225" alter="resources/' . $row['labImage'] . '" src="resources/' . $row['labImage'] . '" >';
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="Labs.php" method="POST" enctype="multipart/form-data">
                        ...
                        <?php }else{?>
                            <div class="mb-3">
                            <input type="hidden" class="form-control" value="<?php echo $deptid; ?>" id="deptId" name="deptId">
                        </div>
                       <?php  }
                        ?>
