    ...
    <footer class="row row-cols-5 py-5 mb-5">
        <div class="col">
            ...
            <div class="row" style="margin: 5px;">
                <img height="75%" width="75%" src="resources/SSGC_logo_name.png" class="img-thumbnail" alt="Ghandhy College Image">
            </div>
            <div class="row fs-6">
                <!-- Text Div  -->
        ...
        <div class="col-2">
            ...
            <h6>
                <ul class="nav flex-column">
                    <li class="nav-item mb-4"><a href="index.php" class="nav-link p-0 text-muted"><i class="fa fa-home"></i> Home</a></li>
                    <li class="nav-item mb-4"><a href="about.php" class="nav-link p-0 text-muted"><i class="fa fa-info-circle"></i> About</a></li>
                    <li class="nav-item mb-4"><a href="gallary.php" class="nav-link p-0 text-muted"><i class="fa fa-image"></i> Gallery</a></li>
                    <li class="nav-item mb-4"><a href="contact_us.php" class="nav-link p-0 text-muted"><i class="fa fa-phone"></i> Contact Us
                        </a></li>
                </ul>
            </h6>
        </div>
