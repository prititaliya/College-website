  ...
  if ($numofrow == 1) {
    if ($row['role'] == 'admin' and $row['username'] == $username) {
      ...
      if (password_verify($password, $row['password'])) {
        ...
        header('Location:/bootproject/index.php?showerror=password incorrect');
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm" id="navbar">
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item px-1 dropdown <?php if ($file == 'about.php') {
          ...
          <a class="nav-link dropdown-toggle font-weight-bold text-uppercase" href="about_folder/about.php" id="servicesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</a>
          <div class="dropdown-menu dropdown-menu-center" aria-labelledby="servicesDropdown" style="border: solid green 3px; ">
            <!-- About Title -->
            ...
            <div class="d-md-flex align-items-start justify-content-start">
              ...
              <div style="width: 250px;">
                ...
                <a class="dropdown-item" href="about_college.php">About College</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_college_campus.php">College Campus</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_placement_cell.php">Placement Cell</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_women_cell.php">Women Cell</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_grievance_cell.php">Greivance Cell</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_antiragging.php">Anti Ragging</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_student_startup.php">Student Startup and Innovation</a>
                <div class="dropdown-divider"></div>

                <a class="dropdown-item" href="about_RTI.php">RTI</a>
                <!-- <div class="dropdown-divider"></div> -->

                <!-- <a class="dropdown-item" href="about_newsletter.php">News Letter</a> -->
              </div>
      ...
      <li class="nav-item px-1 dropdown">
          <a class="nav-link dropdown-toggle font-weight-bold text-uppercase" href="#" id="servicesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Academic</a>
          <div class="dropdown-menu dropdown-menu-center" aria-labelledby="servicesDropdown" style="border:3px solid green ;" style="width: 300px;">
            <!-- Academic Title -->
            <div class="dropdown-header font-weight-bold text-uppercase" href="#" style="display: flex; justify-content: center; align-items: center;">Academic</div>
            <div class="dropdown-divider"></div>
            <div class="d-md-flex align-items-start justify-content-start">

              <div>
                <div class="dropdown-header">Academic Calendar</div>
                <a class="dropdown-item" href="#" aria-disabled="true" style="pointer-events: none;" >Academic Calendar</a>
                <div class="dropdown-divider"></div>
              ...
              <div>
                ...
                <a class="dropdown-item" href="department.php">
                  All Departments</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=APPLIED%20MECHANICS%20ENGG">
                  Applied Mechanics</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=AUTOMOBILE%20ENGG">
                  Automobile Enginnering</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=CIVIL%20ENGG">
                  Civil Enginnering</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=ELECTRICAL%20ENGG">
                  Electrical Enginnering</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=GENERAL">General</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=INFORMATION%20TECHNOLOGY">Information Techonology</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=MECHANICAL%20ENGG">
                  Mechanical Enginnering</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=METALLURGY%20ENGG">
                  Metallurgy Enginnering</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=POWER%20ELECTRONICS">
                  Power Electronics</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=TEXTILE%20MANUFACTURING%20TECHNOLOGY">Textile Manufacturing</a>
                <a class="dropdown-item" href="departmentdetail.php?deptname=TEXTILE%20PROCESSING%20TECHNOLOGY">Textile Processing</a>
              </div>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item px-1 dropdown <?php if ($file == 'Faculty.php') {
          ...
          <div class="dropdown-menu dropdown-menu-center" aria-labelledby="servicesDropdown" style="border:3px solid green ;">
            <!-- People Title -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Please Login to Proceed Further </h5>
  ...
  <?php echo '</div>
      <div class="modal-footer">
            ...
            <a class="btn btn-secondary" href="/bootproject/facultydetail.php?Login=true">Login As Faculty</a>
  ...
  <div class="modal fade modal-dialog modal-dialog-scrollable" id="profileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table">
            <thead>
              <?php
              // if(isset($_SESSION['roleFaculty']))
              if ($_SESSION['roleFaculty'] == 'faculty') {
                try {
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                $tableQuery = "SELECT * FROM `Faculty_Details` where Faculty_Name='$user'";
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        ...
        <div class="modal-footer">
          ...
          if ($_SESSION['role'] == 'faculty') {
            echo '<a href="editDetails.php?facultyId=' . $tbrow['Faculty_Id'] . '"> <button type="button" class="btn btn-warning">Edit ' . $tbrow['Faculty_Name'] . '</button> </a>';
          } else {
            echo '<a href="editDetails.php?sno=' . $tbrow['sno'] . '"> <button type="button" class="btn btn-warning">Edit ' . $tbrow['username'] . '</button> </a>';
          }
          ?>
