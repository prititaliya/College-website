        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="department.php" method="POST">
                    <div class="mb-3">
                        <input type="hidden" value="<?php echo $row['dept_id']; ?>" name="deptid" " class=" form-control" id="editeddeptname" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">change name of <?php echo $row['dept_name'] ?></label>
                        <input type="text" name="editeddeptname" value="<?php echo $row['dept_name']; ?>" class="form-control" id="editeddeptname" aria-describedby="emailHelp" required>
                    </div>
