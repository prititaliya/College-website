...
$imageId= $_GET['imageId'];
    ...
    <form action="gallary.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="exampleInputImageDesc" class="form-label">Image description <sub>recommended 150 words only*</sub> </label>
            <input type="text" value="'.$row['imageDesc'].'" id="test" class="form-control" name="inputedImageDesc" id="exampleInputImageDesc">
        </div>
        <div class="mb-3">
            <label for="alterText" class="form-label">Enter the text for image incase for any reasons image is not visible we can show that text <sub>recommended 18 words only*</sub></label>
