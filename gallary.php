...
<body>
    ...
    <div class="container">
        <?php if (isset($_SESSION['role'])) if ($_SESSION['username'] == 'admin' && isset($_SESSION['username'])) {
    ...
    echo '<div class="card-body my-3 mx-5 mb-3" style="border-radius:25px;border: 1px solid black;background-color:rgba(0,0,0,.03);"> ';
    for ($i = 0; $i < $iteration; $i++) {
        ...
        for ($j = 0; $j < 3; $j++) {
            echo ' <div class="card shadow-sm"><center>
            <img class="Effect my-3" style="border-radius:25px"   width="75%" src="resources/' . $row['imageName'] . '" ></center>
            <div class="card-body">
